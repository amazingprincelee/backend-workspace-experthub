...
const workspaceNoticeRouter = require('./routes/workspaceNoticeRoute.js');
...
const workspaceStartUpKitRouter = require('./routes/workspaceStartupKit.js');
...
app.use('/workspace-notice', workspaceNoticeRouter);
app.use('/transactions', transactionRouter);
app.use('/appointment', appointmentRouter);
app.use('/certificate', certificateRouter);
app.use('/start-up-kit', startUpKitRouter);
app.use('/workspacestart-up-kit', workspaceStartUpKitRouter);
